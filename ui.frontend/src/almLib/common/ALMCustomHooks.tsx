...
class ALMCustomHooks implements ICustomHooks {
  ...
  async getTraining(
    ...
    try {
      ...
      if(e.status === 401) {
        document.cookie = "user=; Path=" + sitePath() + "; Expires=Thu, 01 Jan 1970 00:00:01 GMT;";
        document.cookie ="alm_cp_token=; Path=" + sitePath() + "; Expires=Thu, 01 Jan 1970 00:00:01 GMT;";
