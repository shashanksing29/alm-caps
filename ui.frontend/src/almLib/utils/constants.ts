...
export const PROD_PREHIRE_LXP_URL = "https://start-at-ibm.yourlearning.ibm.com/";
export const QA_OR_ACCEPTANCE_LXP_URL = "https://start-at-ibm.test.yourlearning.ibm.com/";
